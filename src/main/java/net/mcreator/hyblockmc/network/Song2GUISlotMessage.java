...
public class Song2GUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public Song2GUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public Song2GUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(Song2GUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Song2GUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = Song2GUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		HyblockMod.addNetworkMessage(Song2GUISlotMessage.class, Song2GUISlotMessage::buffer, Song2GUISlotMessage::new, Song2GUISlotMessage::handler);
	}
}
