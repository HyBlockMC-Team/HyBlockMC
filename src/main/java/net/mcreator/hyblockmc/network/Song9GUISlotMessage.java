...
public class Song9GUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public Song9GUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public Song9GUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(Song9GUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Song9GUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = Song9GUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		HyblockMod.addNetworkMessage(Song9GUISlotMessage.class, Song9GUISlotMessage::buffer, Song9GUISlotMessage::new, Song9GUISlotMessage::handler);
	}
}
