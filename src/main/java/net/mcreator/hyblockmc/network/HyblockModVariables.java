...
public class HyblockModVariables {
	...
	public static class MapVariables extends SavedData {
		...
		public BlockState boom = Blocks.AIR.defaultBlockState();
		...
		public void read(CompoundTag nbt) {
			boom = NbtUtils.readBlockState(BuiltInRegistries.BLOCK.asLookup(), nbt.getCompound("boom"));
		}

		@Override
		public CompoundTag save(CompoundTag nbt) {
			nbt.put("boom", NbtUtils.writeBlockState(boom));
			return nbt;
		}
