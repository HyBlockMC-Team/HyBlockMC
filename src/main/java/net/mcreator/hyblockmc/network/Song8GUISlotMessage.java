...
public class Song8GUISlotMessage {
	...
	public Song8GUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(Song8GUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Song8GUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
