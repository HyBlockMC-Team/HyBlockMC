...
public class Song6GUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public Song6GUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public Song6GUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(Song6GUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Song6GUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = Song6GUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		HyblockMod.addNetworkMessage(Song6GUISlotMessage.class, Song6GUISlotMessage::buffer, Song6GUISlotMessage::new, Song6GUISlotMessage::handler);
	}
}
