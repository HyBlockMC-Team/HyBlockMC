...
public class Song5GUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public Song5GUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public Song5GUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(Song5GUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Song5GUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = Song5GUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		HyblockMod.addNetworkMessage(Song5GUISlotMessage.class, Song5GUISlotMessage::buffer, Song5GUISlotMessage::new, Song5GUISlotMessage::handler);
	}
}
