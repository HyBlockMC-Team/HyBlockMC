...
public class Song7GUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public Song7GUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public Song7GUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(Song7GUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Song7GUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = Song7GUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		HyblockMod.addNetworkMessage(Song7GUISlotMessage.class, Song7GUISlotMessage::buffer, Song7GUISlotMessage::new, Song7GUISlotMessage::handler);
	}
}
