...
public class Song1GUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public Song1GUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public Song1GUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(Song1GUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Song1GUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = Song1GUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		HyblockMod.addNetworkMessage(Song1GUISlotMessage.class, Song1GUISlotMessage::buffer, Song1GUISlotMessage::new, Song1GUISlotMessage::handler);
	}
}
