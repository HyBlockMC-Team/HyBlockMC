...
public class Song11GUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public Song11GUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public Song11GUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(Song11GUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Song11GUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = Song11GUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		HyblockMod.addNetworkMessage(Song11GUISlotMessage.class, Song11GUISlotMessage::buffer, Song11GUISlotMessage::new, Song11GUISlotMessage::handler);
	}
}
