...
public class Song4GUISlotMessage {

	private final int slotID, x, y, z, changeType, meta;

	public Song4GUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public Song4GUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(Song4GUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Song4GUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = Song4GUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		HyblockMod.addNetworkMessage(Song4GUISlotMessage.class, Song4GUISlotMessage::buffer, Song4GUISlotMessage::new, Song4GUISlotMessage::handler);
	}
