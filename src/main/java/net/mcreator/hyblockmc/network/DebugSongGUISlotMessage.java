...
public class DebugSongGUISlotMessage {
	...
	public DebugSongGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(DebugSongGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(DebugSongGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
