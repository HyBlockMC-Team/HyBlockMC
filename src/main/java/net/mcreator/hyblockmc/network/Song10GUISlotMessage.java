...
public class Song10GUISlotMessage {

	private final int slotID, x, y, z, changeType, meta;

	public Song10GUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public Song10GUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(Song10GUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Song10GUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = Song10GUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		HyblockMod.addNetworkMessage(Song10GUISlotMessage.class, Song10GUISlotMessage::buffer, Song10GUISlotMessage::new, Song10GUISlotMessage::handler);
	}
