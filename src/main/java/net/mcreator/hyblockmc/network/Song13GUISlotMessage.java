...
public class Song13GUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public Song13GUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public Song13GUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(Song13GUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Song13GUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = Song13GUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		HyblockMod.addNetworkMessage(Song13GUISlotMessage.class, Song13GUISlotMessage::buffer, Song13GUISlotMessage::new, Song13GUISlotMessage::handler);
	}
}
