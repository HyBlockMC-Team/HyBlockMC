...
package net.mcreator.hyblockmc.entity;
...
public class RevenanthorrorT1Entity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

	public RevenanthorrorT1Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(HyblockModEntities.REVENANTHORROR_T_1.get(), world);
	}

	public RevenanthorrorT1Entity(EntityType<RevenanthorrorT1Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 60;
		setNoAi(false);
		setCustomName(Component.literal("Revenant Horror"));
