...
public class TestdummyEntity extends PathfinderMob {
	...
	public TestdummyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HyblockModEntities.TESTDUMMY.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(HyblockModEntities.TESTDUMMY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
