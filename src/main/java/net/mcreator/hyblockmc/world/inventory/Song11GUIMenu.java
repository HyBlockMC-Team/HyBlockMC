...
import net.mcreator.hyblockmc.network.Song11GUISlotMessage;
...
public class Song11GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Song11GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HyblockModMenus.SONG_11_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			HyblockMod.PACKET_HANDLER.sendToServer(new Song11GUISlotMessage(slotid, x, y, z, ctype, meta));
			Song11GUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
