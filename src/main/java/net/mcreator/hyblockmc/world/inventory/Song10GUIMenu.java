...
import net.mcreator.hyblockmc.network.Song10GUISlotMessage;
...
public class Song10GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			HyblockMod.PACKET_HANDLER.sendToServer(new Song10GUISlotMessage(slotid, x, y, z, ctype, meta));
			Song10GUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
