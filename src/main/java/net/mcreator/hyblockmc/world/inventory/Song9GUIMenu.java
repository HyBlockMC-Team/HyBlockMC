...
import net.mcreator.hyblockmc.network.Song9GUISlotMessage;
...
public class Song9GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Song9GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HyblockModMenus.SONG_9_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			HyblockMod.PACKET_HANDLER.sendToServer(new Song9GUISlotMessage(slotid, x, y, z, ctype, meta));
			Song9GUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
