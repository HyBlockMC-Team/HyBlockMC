...
import net.mcreator.hyblockmc.network.Song12GUISlotMessage;
...
public class Song12GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Song12GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HyblockModMenus.SONG_12_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			HyblockMod.PACKET_HANDLER.sendToServer(new Song12GUISlotMessage(slotid, x, y, z, ctype, meta));
			Song12GUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
