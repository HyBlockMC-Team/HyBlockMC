...
public class Song7GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Song7GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HyblockModMenus.SONG_7_GUI.get(), id);
