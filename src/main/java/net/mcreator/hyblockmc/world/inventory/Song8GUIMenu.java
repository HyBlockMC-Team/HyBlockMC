...
import net.mcreator.hyblockmc.network.Song8GUISlotMessage;
...
public class Song8GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Song8GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HyblockModMenus.SONG_8_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			HyblockMod.PACKET_HANDLER.sendToServer(new Song8GUISlotMessage(slotid, x, y, z, ctype, meta));
			Song8GUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
