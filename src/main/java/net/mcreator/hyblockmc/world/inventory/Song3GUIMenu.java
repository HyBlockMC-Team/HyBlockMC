...
import net.mcreator.hyblockmc.network.Song3GUISlotMessage;
...
public class Song3GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Song3GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HyblockModMenus.SONG_3_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			HyblockMod.PACKET_HANDLER.sendToServer(new Song3GUISlotMessage(slotid, x, y, z, ctype, meta));
			Song3GUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
