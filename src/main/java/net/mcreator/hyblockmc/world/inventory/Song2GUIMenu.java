...
import net.mcreator.hyblockmc.network.Song2GUISlotMessage;
...
public class Song2GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Song2GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HyblockModMenus.SONG_2_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			HyblockMod.PACKET_HANDLER.sendToServer(new Song2GUISlotMessage(slotid, x, y, z, ctype, meta));
			Song2GUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
