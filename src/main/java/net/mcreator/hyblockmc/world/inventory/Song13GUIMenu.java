...
import net.mcreator.hyblockmc.network.Song13GUISlotMessage;
...
public class Song13GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Song13GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HyblockModMenus.SONG_13_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			HyblockMod.PACKET_HANDLER.sendToServer(new Song13GUISlotMessage(slotid, x, y, z, ctype, meta));
			Song13GUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
