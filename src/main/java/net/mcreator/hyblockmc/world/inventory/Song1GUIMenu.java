...
import net.mcreator.hyblockmc.network.Song1GUISlotMessage;
...
public class Song1GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Song1GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HyblockModMenus.SONG_1_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			HyblockMod.PACKET_HANDLER.sendToServer(new Song1GUISlotMessage(slotid, x, y, z, ctype, meta));
			Song1GUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
