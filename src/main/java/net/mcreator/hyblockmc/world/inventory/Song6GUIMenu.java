...
import net.mcreator.hyblockmc.network.Song6GUISlotMessage;
...
public class Song6GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Song6GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HyblockModMenus.SONG_6_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			HyblockMod.PACKET_HANDLER.sendToServer(new Song6GUISlotMessage(slotid, x, y, z, ctype, meta));
			Song6GUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
