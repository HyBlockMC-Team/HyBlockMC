...
import net.mcreator.hyblockmc.network.DebugSongGUISlotMessage;
...
public class DebugSongGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DebugSongGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HyblockModMenus.DEBUG_SONG_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			HyblockMod.PACKET_HANDLER.sendToServer(new DebugSongGUISlotMessage(slotid, x, y, z, ctype, meta));
			DebugSongGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
