...
import net.mcreator.hyblockmc.procedures.AdminSwordSharpness2Procedure;

import java.util.List;

public class Adminsword2Item extends SwordItem {
	public Adminsword2Item() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A77Damage: \u00A7c+999"));
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			AdminSwordSharpness2Procedure.execute(entity);
	}
}
