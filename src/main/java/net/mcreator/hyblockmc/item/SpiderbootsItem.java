...
public abstract class SpiderbootsItem extends ArmorItem {
	public SpiderbootsItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Boots extends SpiderbootsItem {
		public Boots() {
