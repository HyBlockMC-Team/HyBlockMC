...
public class Summonrevenantbosst3Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == HyblockModBlocks.REVENANTSPAWNERBLOCK.get() || (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == HyblockModBlocks.SLAYERSPAWNERKEYSTONEBLOCK.get())
				&& ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == HyblockModItems.REVENANTKEYSTONETABLET_T_3.get()
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = EntityType.CAMEL.spawn(_level, BlockPos.containing(x + Mth.nextDouble(RandomSource.create(), 0.5, 0.5), y + 1, z + Mth.nextDouble(RandomSource.create(), 0.5, 0.5)), MobSpawnType.MOB_SUMMONED);
