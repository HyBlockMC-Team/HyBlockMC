...
((Slot) _slt.get(24)).getItem() : ItemStack.EMPTY).getItem() == HyblockModBlocks.YELLOW_FALLING_MELODY.get().asItem()) {if (==false) {if (world instanceof Level _level) {
if (!_level.isClientSide()) {
_level.playSound(null, BlockPos.containing(x,y,z),
ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("hyblock:harp_yellow_note")),
